<template>
    <div id="app">
            ...
            <ul class="header__navbar">
                ...
                <transition name="dropdown">
                    ...
                    <ul class="dropdown__menu-nav">
                        <li class="dropdown__menu-item" v-for="(item, index) in  selections" :key="index">
                            <a href="#" class="dropdown__menu-link" :title="item.title" @click="item.method">
                                <div class="dropdown__menu-text">{{ item.title }}</div>
                            </a>
                        </li>
        ...
        <authentication :logIn="logIn" :signUp="signUp" @closeAuth="closeAuth"/>
    </div>
</template>
...
export default {
    ...
    props: [ 'darkMode', 'isAuth', 'logIn', 'signUp' ],
    ...
    methods: {
        startSignin: function() {
            this.show = false;
            this.$emit('promptLogin')
            // Authentication.logIn = true;
            // Authentication.Signup = false;
            // Authentication.methods.openLogin();
        },
        closeAuth() {
            this.$emit('closeAuth');
        }
...
.header {
    color: darken($color-navbar-bg, 10%);
    background-color: $color-navbar-bg;
    border: transparent !important;
}

#app.dark .dropdown__menu {
    color: lighten($color-navbar-bg-dark, 10%);
    background-color: $color-navbar-bg-dark;
}
